...
export default async function Home() {
  return (
    <>
      <section className="bg-black h-full w-full pt-36 relative flex items-center justify-center flex-col">
        ...
        <p className="text-center mt-[700px]">Run your agency, in one place</p>
